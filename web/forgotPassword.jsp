...
<html lang="en">
    ...
    <body class="signup-form" >
        ...
        <!--end of menu-->
        <div >
            <form action="forgotpass" method="post" class="form-horizontal" style="color: black">
                <div class="row">
                ...
                <div class="form-group row">
                    <div class="col-8 offset-4">
                        ...
                        <button type="" class="btn btn-primary btn-lg"><a href="index.jsp" style="color:white">Home</a></button>
