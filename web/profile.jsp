        ...
        <div class="col-sm-9">
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="home">
                    <hr>
                        <form class="form" action="profile?op=edit" method="post" id="registrationForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-6">
                                    ...
                                    <input type="password" class="form-control" name="pass" id="password" value="${acc.password}" required>
                                </div>
                            </div>
                            <div class="form-group">
                                <div class="col-xs-12">
